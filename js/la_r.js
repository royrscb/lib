/* la_r.js v = 1 | Roy Ros Cobo | github.com/royrscb */
// Versions without the new roxtions.js
...
const La = {
    ...
    get: {
        ...
        */
        ...
        device() {
			...
			let current_device = width <= 600 ? La.DEVICE.mobile
				: width < 768 ? La.DEVICE.tablet
				: La.DEVICE.desktop
	...
	is: {
        ...
        mobileDevice: () => La.is.device(La.DEVICE.mobile),
        tabletDevice: () => La.is.device(La.DEVICE.tablet),
        desktopDevice: () => La.is.device(La.DEVICE.desktop),
    ...
    COUNTRIES = [
        ...
        { code: "CG", flag: "🇨🇬", name: "Republic of the Congo" },
