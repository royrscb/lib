		...
		private function connect($ttl){
			...
			$auth = [
				...
				'VAPID' => [
					...
					'subject' => 'https://.es',
					'publicKey' => 'BBsbXBEWO9MXw6Aw13uwSL6taFq1d3i-hMOX9sloJs0wDeR0iyk8tYyjpK-QdBbxdYCvh43vC0_1n2bpDDT2z2s',
					'privateKey' => 'efVXzc5bhecbREPWGQ42zwvImeMDKY0LGvvHdu9jgBE'
				]
			];
