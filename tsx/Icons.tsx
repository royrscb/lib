...
export function Eye(props: IcoProps
    & {
        off: boolean;
    }
): React.JSX.Element {
...
export function Check(props: IcoProps): React.JSX.Element {
    return <Ico
        viewBox='0 -960 960 960'
...
export function Cross(props: IcoProps): React.JSX.Element {
    return <Ico
        viewBox='0 -960 960 960'
